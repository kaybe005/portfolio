...
const ContactSection: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <Terminal title="CONTACT.INFO" className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <LabPanel title="CONTACT CHANNELS" glowing>
            ...
            {contactChannels.map((channel, index) => (
              <div key={index} className="flex items-center p-3 bg-black/30 rounded border border-dexter-teal">
                ...
                <div>
                  ...
                  <p className="text-dexter-green font-share-tech">{channel.value}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <LabPanel title="SECURE MESSAGE TRANSMISSION">
          <ContactForm />
        </LabPanel>
      </div>
    </div>
